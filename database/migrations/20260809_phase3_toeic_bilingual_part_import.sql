-- ============================================================
-- Phase P3.5J Revised: Admin Atomic TOEIC Bilingual Part Content Importer RPC
-- Migration: 20260809_phase3_toeic_bilingual_part_import.sql
-- Function: public.admin_import_toeic_part_content
-- Atomic transaction to upsert groups & questions with full EN + VI bilingual fields.
-- ============================================================
